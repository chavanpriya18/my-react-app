...
//   return (
//     <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-black via-gray-800 to-gray-900 bg-opacity-80">
...
//             />
//             <small className="text-gray-500 text-xs">Max 400 characters</small>
//           </div>
//           <div>
//             <label className="block mb-1 text-sm font-medium text-gray-700">
//               Password
...
//           <button
//             type="submit"
//             className="w-full py-3 text-white bg-purple-600 rounded-md hover:bg-purple-700 transition duration-300"
//           >
//             Register
//           </button>
//         </form>
