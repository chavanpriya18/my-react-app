...
// import LoginIllustration from "../../public/img/vecteezy_happy-school-girl-isolated_26991984.png"; // save your uploaded image here
...
//               required
//               className="w-full px-4 py-3 bg-white/10 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-white text-white"
//             />
//           </div>
//           <div>
//             <input
...
//             REGISTER
//           </Link>
//           <Link to="/forgot-password" className="hover:text-white hover:underline transition">
//             FORGOT PASSWORD
//           </Link>
//         </div>
//       </div>
