...
//       <h1 className="text-4xl font-bold mb-6">Store Owner Dashboard</h1>

//       <section className="mb-10">
//         <h2 className="text-2xl font-semibold mb-2">Your Store Average Rating</h2>
//         <p className="text-5xl font-bold text-yellow-500">{averageRating.toFixed(1)}</p>
//       </section>
