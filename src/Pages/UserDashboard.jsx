...
// const stores = [
//   { id: 1, name: "Store A", address: "123 Street", overallRating: 4.5, userRating: 4 },
//   { id: 2, name: "Store B", address: "456 Avenue", overallRating: 3.9, userRating: null },
// ];
...
//               <th className="p-4 text-left">Overall Rating</th>
//               <th className="p-4 text-left">Your Rating</th>
//             </tr>
//           </thead>
//           <tbody>
//             {stores.map((store) => (
